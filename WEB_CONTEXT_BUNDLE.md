...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:erdosproblems-123",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "erdosproblems:123",
    ...
    "statement": {
      "language": "en",
      "text": "Draft bounty intake target(s): Erdős Problem #123. The exact mathematical statement, quantifiers, definitions, assumptions, and acceptance conditions have not yet been frozen; this draft is not research-admitted.",
      "version": 1
    },
    "title": "Erdős Problem #123",
    "updated_at": "2026-09-08T08:24:29Z"
  },
  "problem_contract_sha256": "6dbce2e0738b7d35ab9aa0bd2cbae09180478389bc45e4f57101b1d1ac096840"
}
```
